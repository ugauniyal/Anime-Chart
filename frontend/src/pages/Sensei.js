...
function SenseiNodes() {
  const [nodes, setNodes] = useState([]);

  useEffect(() => {
    // Fetch sensei relationships
    axios.get('http://localhost:8000/test_api/sensei_nodes')
      .then(response => {
  ...
  return (
    <div className="container">
      <h1>Hierarchical Relationships (Sensei)</h1>
      <div className="tree">
